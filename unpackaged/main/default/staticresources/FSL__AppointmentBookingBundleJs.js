...
(function () {
    ...
    function StateAndSettings(APP_STATES, datesService, $q, MstResolver, $rootScope) {
        ...
        this.runAgainWhenPolicyChanged = function (policyId) {
            _this.policyUsed = policyId;
            _this.controlServiceForm.doFirstStage({ PolicyOverrideId: policyId }).then(_this.onFirstStageComplete);
        };
        ...
        this.onFirstStageComplete = function (results) {
            ...
            _this.policyUsed = results.firstStageResult.Data.policyId;
    ...
    function slotsCtrl($q, StateAndSettings, APP_STATES, Labels, $timeout, chatterActionUtils, MstResolver) {
        ...
        this.schedule = function (slot) {
            ...
            StateAndSettings.controlServiceForm.doSecondStage({
                ...
                PolicyOverrideId: _this.selectedPolicy
        ...
        this.extendDate = function () {
            ...
            StateAndSettings.extendDates(_this.selectedPolicy).then(function () {
