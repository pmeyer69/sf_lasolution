    ...
    angular.module('serviceExpert').factory('sfdcService', ['$q', '$rootScope', 'userSettingsManager', function ($q, $rootScope, userSettingsManager) {
        ...
        sfdc.saveChangesToServiceAppointment = function (serviceAppointmentId, newResourceId, currentAssignedResourceId, strStartDate, strFinishDate, usedPolicyId, scheduleMode, snapToId, snapToType, snapDirection, calcTravelToLatitude, calcTravelToLongitude) {
            ...
            remoteDeffered.promise.then(function () {
                ...
                Visualforce.remoting.Manager.invokeAction(RemoteActions.saveChangesToServiceAppointment, serviceAppointmentId, newResourceId, currentAssignedResourceId, strStartDate, strFinishDate, usedPolicyId, scheduleMode, snapToId, snapToType, snapDirection, calcTravelToLatitude, calcTravelToLongitude, getFilteredLocations(), isFirstServiceOfConsecutive, function (result, ev) {
