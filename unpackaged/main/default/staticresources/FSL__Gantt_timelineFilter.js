...
(function () {
    ...
    Resource.prototype.generateHtml = function (resourceObject) {
        ...
        var displayedLabel = resourceObject.ganttLabel ? resourceObject.ganttLabel.encodeHTML() : '';
        ...
        if (scheduler._mode === 'MonthlyView' && this.utilization !== null) {
            ...
            if (scheduler.matrix.ZoomLevel3.dy < 33) {
                this.label += '<a resource=\'' + this.id + '\' class="truncate smallResourceNameField" title=\'' + this.name.encodeHTML() + ' ' + (resourceObject.description ? ' - ' + resourceObject.description.encodeHTML() : '') + '\'>' + this.name.encodeHTML() + ' ' + secondaryText + '\n                    <div class=\'smallResourceGanttLabel truncate\'>' + displayedLabel + '</div></a>';
            } else {
                this.label += '<a resource=\'' + this.id + '\' class=\'truncate smallResourceName resourceYup\' title=\'' + this.name.encodeHTML() + ' ' + (resourceObject.description ? ' - ' + resourceObject.description.encodeHTML() : '') + '\'>' + this.name.encodeHTML() + ' ' + secondaryText + '\n                    <div class=\'resourceGanttLabel truncate\'>' + displayedLabel + '</div></a>';
            }
        } else {
            //if (scheduler._mode !== 'MonthlyView') {
            ...
            if (resourceObject.ganttLabel) {
                ...
                if (scheduler.matrix.ZoomLevel3.dy < 33) {
                    this.label += '<a resource=\'' + this.id + '\' class=\'truncate smallResourceName resourceYup resource-no-label\' style=\'margin-top:1px;\' title=\'' + this.name.encodeHTML() + ' ' + (resourceObject.description ? ' - ' + resourceObject.description.encodeHTML() : '') + '\'>' + this.name.encodeHTML() + ' ' + secondaryText + '</a>';
                } else {
                    this.label += '<a class="truncate resource-no-label" resource=\'' + this.id + '\' style=\'margin-top:1px;\' title=\'' + this.name.encodeHTML() + ' ' + (resourceObject.description ? ' - ' + resourceObject.description.encodeHTML() : '') + '\'>' + this.name.encodeHTML() + ' ' + secondaryText + '</a>';
                }
            }
        }
